    ...
    */
    ...
    describe('Initial Entries', function() {
         ...
         */
         beforeEach(function(done) {
            // test with first item in feed array
            loadFeed(0, done);
         });

         it('should be at least one .entry element within .feed container after loadFeed completes', function(done) {
            expect($('.feed').contents().find('.entry').length).toBeGreaterThan(0);
            done();
         });
    ...
    describe('New Feed Selection', function() {
         ...
         */
         ...
         beforeEach(function(done) {            
            // load first feed and set firstFeed equal to the feed's text
            loadFeed(0, function() {
                firstFeed = $('.feed').text();
                done();
            });
